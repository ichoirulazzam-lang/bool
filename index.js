...
// Configuration
const apikey = 'ptla_AP1g13qZuOOpOczodZrXjbJRJZLvSRtfU1IR7OqoiHg';
const capikey = 'ptlc_YCjbMyPJVWnyFIck85EMs5u3H8XcUOB5XAyNQne0VAa';
const domain = 'https://zerossz.storeid.my.id';
const nestid = '5';
const egg = '15';
const loc = '1';
const gmailadmin = 'admin@gmail.com'; // Admin email that won't be deleted
const telegramBotToken = '8450857226:AAGMqQYMkmXcX0PjBpnHXUR1hML4WR44Qqk';
const adminTelegramId = '7314158034';
